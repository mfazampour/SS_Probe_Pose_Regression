...
# from ..util import util
# sys.path.append("..")
# from cut.models import get_option_setter as models_get_option_setter
# from cut.data import get_option_setter as data_get_option_setter
from .. import models
from .. import data


# sys.path.insert(0, '/code/cut/util')
# from util import str2bool, mkdirs
# from cut import models
# from cut import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--load_size', type=int, default=148, help='scale images to this size')

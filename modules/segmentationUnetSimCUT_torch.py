...
class SegmentationSim(torch.nn.Module):
    def __init__(self, params, opt_cut, outer_model, inner_model):
        ...
        self.seg_optimizer, self.optimizer_D = self.configure_optimizers()
    ...
    def normalize_torch_img(self, img):
        return (img - torch.min(img)) / (torch.max(img) - torch.min(img))
    ...
    def configure_optimizers(self):
        ...
        return seg_optimizer,seg_scheduler  #, discr_scheduler, optimizer_D
